...
namespace RobotAutomationHelper.Forms
{
    public class BaseKeywordAddForm : Form
    {
        ...
        protected void InstantiateVariablesAddForm(object sender, EventArgs e)
        {
            ...
            var addVariablesForm = new VariablesAddForm(this);
            //AddSettingsForm.FormClosing += new FormClosingEventHandler(UpdateThisFormAfterImplementedChildKeyword);
            addVariablesForm.ShowVariablesContent();
        }
        ...
        protected void AddKeywordField(Keyword keyword, int keywordsCounter, bool newKeyword, bool showAddRemoveButtons)
        {
            var settingsLabel = 0;
            if (FormType == FormType.Settings)
                settingsLabel = KeywordFieldConsts.SettingsLabelWidth - KeywordFieldConsts.LabelWidth;
